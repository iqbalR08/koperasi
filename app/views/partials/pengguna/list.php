                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-no_telp"> No.Telpon</th>
                                                <th  class="td-alamat_agt"> Alamat</th>
                                                <th  class="td-ttl_agt"> TTL</th>
                                                <th  class="td-jenis_kelamin_agt"> Jenis Kelamin</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-alamat_agt">
                                                        <span  data-value="<?php echo $data['alamat_agt']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pengguna/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-ttl_agt">
                                                        <span  data-value="<?php echo $data['ttl_agt']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pengguna/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="ttl_agt" 
                                                    ...
                                                    <td class="td-jenis_kelamin_agt">
                                                        <span  data-value="<?php echo $data['jenis_kelamin_agt']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("pengguna/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-photo">
                                                        <span  data-value=<?php Html :: page_img($data['photo'],50,50,9); ?>                                                     
                                                        </span>
                                                    </td>
