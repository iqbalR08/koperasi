            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-vertical needs-validation" action="<?php print_link("pengguna/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-no_telp-holder" class=""> 
                                                <input id="ctrl-no_telp"  value="<?php  echo $data['no_telp']; ?>" type="text" placeholder="Enter Nomor"  required="" name="no_telp"  class="form-control " />
                                                </div>
                                            </div>
                                        <div class="form-group ">
                                            <label class="control-label" for="alamat_agt">Alamat <span class="text-danger">*</span></label>
                                            <div id="ctrl-alamat_agt-holder" class=""> 
                                                <input id="ctrl-alamat_agt"  value="<?php  echo $data['alamat_agt']; ?>" type="text" placeholder="Enter Alamat"  required="" name="alamat_agt"  class="form-control " />
                                                </div>
                                            </div>
                                        <div class="form-group ">
                                            <label class="control-label" for="ttl_agt">TTL <span class="text-danger">*</span></label>
                                            <div id="ctrl-ttl_agt-holder" class=""> 
                                                <input id="ctrl-ttl_agt"  value="<?php  echo $data['ttl_agt']; ?>" type="text" placeholder="Enter TTL"  required="" name="ttl_agt"  class="form-control " />
                                                </div>
                                            </div>
                                        <div class="form-group ">
                                            ...
                                            <div id="ctrl-jenis_kelamin_agt-holder" class=""> 
                                                <input id="ctrl-jenis_kelamin_agt"  value="<?php  echo $data['jenis_kelamin_agt']; ?>" type="text" placeholder="Enter Jenis Kelamin"  required="" name="jenis_kelamin_agt"  class="form-control " />
                                                </div>
                                            </div>                                                
                                            <div class="form-group ">
