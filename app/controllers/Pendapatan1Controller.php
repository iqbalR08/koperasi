<?php 
/**
 * pendapatan1 Page Controller
 * @category  Controller
 */
class pendapatan1Controller extends SecureController{
	...
	function view($rec_id = null, $value = null){
		...
		if($record){
			$page_title = $this->view->page_title = "View  Pendapatan";
			$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
			$this->view->report_title = $page_title;
			$this->view->report_layout = "report_layout.php";
			$this->view->report_paper_size = "A4";
	...
	function edit($rec_id = null, $formdata = null){
		...
		$page_title = $this->view->page_title = "Edit  Pendapatan";
		if(!$data){
			$this->set_page_error();
		}
