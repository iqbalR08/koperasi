...
class PenggunaController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				pengguna.no_telp LIKE ? OR 				
				pengguna.alamat_agt LIKE ? OR 
				pengguna.ttl_agt LIKE ? OR 
				pengguna.jenis_kelamin_agt LIKE ? OR 
				pengguna.photo LIKE ? OR 
				pengguna.file_surat LIKE ? OR
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","password","nama","email","no_telp","alamat_agt","ttl_agt","jenis_kelamin_agt","photo","file_surat","user_role_id");
			...
			$this->sanitize_array = array(
				...
				'alamat_agt' => 'sanitize_string',
				'ttl_agt' => 'sanitize_string',
				'jenis_kelamin_agt' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","username","password","nama","no_telp","alamat_agt","ttl_agt","jenis_kelamin_agt","photo","file_surat","user_role_id");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'username' => 'required',
